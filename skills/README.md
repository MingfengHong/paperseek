...
- `scripts/paperseek_skill_runtime.py`：无第三方依赖的核心检索 runtime，可直接检索 OpenAlex、arXiv、Semantic Scholar、PubMed、Google Scholar（通过 Serper）、计算机顶会、Crossref 和带 key 的 WoS Starter。
...
- 用自然语言研究问题运行文献检索。
- 在 OpenAlex、arXiv、Semantic Scholar、PubMed、Google Scholar、计算机顶会、Crossref、WoS Starter 之间选择合适数据源。
